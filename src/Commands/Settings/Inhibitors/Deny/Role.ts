...
export default class extends Command {
    constructor() {
        super(
            ...
            [ /* No extra perms needed */ ],
            {
                ...
                args: [1, 2],
                guildOnly: true,
                aliases: [ 'blacklistrole', 'denyrole' ]
            }
        );
    }
    ...
    async init(message: Message, args: string[], settings: GuildSettings) {
        ...
        if(!role) {
            ...
            return message.channel.send(this.Embed.fail('Deleted Role!'));
        }
        ...
        if(settings?.disabledRole?.some(c => 
            ...
            return message.channel.send(this.Embed.fail(`Command is already disabled for this role!`));
        }
        ...
        if(inserted.modifiedCount === 1 || inserted.upsertedCount === 1) {
            ...
            Command ${command[0]} has been disabled for ${role}!
            `));
        } else {
