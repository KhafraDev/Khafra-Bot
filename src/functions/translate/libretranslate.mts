...
const optionSchema = (langs: Set<string>) =>
  s.object({
    to: s.string.optional.default('en').transform((value) => (langs.has(value) ? value : 'en')),
    from: s.string.optional.default('auto').transform((value) => (langs.has(value) ? value : 'auto')),
    query: s.string
  })
