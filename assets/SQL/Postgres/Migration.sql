...
ALTER TABLE "kbReminders" ADD COLUMN IF NOT EXISTS "didEnd" BOOLEAN DEFAULT FALSE;
ALTER TABLE "kbReminders" ADD COLUMN IF NOT EXISTS "paused" BOOLEAN DEFAULT FALSE;

ALTER TABLE "kbCases" ADD COLUMN IF NOT EXISTS "staffReason" TEXT DEFAULT '';
ALTER TABLE "kbCases" ADD COLUMN IF NOT EXISTS "userReason" TEXT DEFAULT '';
ALTER TABLE "kbCases" DROP COLUMN IF EXISTS "reason";
